...
namespace Ctec_Materiais.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public MaterialsController(MateriaisContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdMaterial,Nome,Codigo")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMaterial,Nome,Codigo")] Material material)
        {
